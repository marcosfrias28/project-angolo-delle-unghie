...
function Contacts() {
    return (
        <section id="Contattami" className="bg-cover bg-no-repeat bg-center Home w-full h-screen xl:max-h-svh flex place-content-center place-items-center max-[360px]:flex sm:flex-col sm:flex-wrap">
        ...
        <section className="absolute h-screen w-screen opacity-5">
